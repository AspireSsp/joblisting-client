        ...
        <TableBody>
            <TableRow>
                ...
                <Button onClick={handleClickOpen}>
                    <AddIcon color="primary" /> &nbsp; &nbsp; &nbsp; ACADEMICS/ PERSONAL PROJECTS
                </Button>
                </TableCell>
            </TableRow>
        <BootstrapDialog
        ...
        >
            ...
            <DialogContent dividers>
              <FormGroup sx={{alignItems :"flex-start", marginBottom : "10px"}}>
                  ...
                  <TextField size='small' fullWidth label="e.g. social media app" id="fullWidth" />
              </FormGroup>
              <Box sx={{display: 'flex'}}>
              ...
              <FormGroup sx={{alignItems :"flex-start", marginBottom : "10px"}}>
                  ...
                  <TextField size='small' fullWidth label="your project link" id="fullWidth" />
              </FormGroup>         
            </DialogContent>
            <DialogActions>
