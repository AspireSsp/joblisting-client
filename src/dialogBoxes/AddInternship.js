       ...
       <TableBody>
            <TableRow>
                ...
                <TableCell>
                    <Button onClick={handleClickOpen} >
                        <AddIcon color="primary" /> &nbsp; &nbsp; &nbsp; Add INTERNSHIPS
                    </Button>
                </TableCell>
            </TableRow>
        <BootstrapDialog
        ...
        >
            ...
            <DialogContent dividers>
              ...
              <Box>
                <FormControlLabel control={<Checkbox defaultChecked />} label="Is work from Home" />
              </Box>
              <Box sx={{display: 'flex'}}>
              ...
              <Box>
                <FormControlLabel control={<Checkbox defaultChecked />} label="Currently working here." />
              </Box>
              <Box>
              <div class="mb-3">
